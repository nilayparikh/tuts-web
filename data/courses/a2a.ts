...
import { A2A_TRANSCRIPTS } from "./a2a.transcripts";
...
export const A2A_COURSE: CourseDefinition = {
  ...
  parts: [
    // ── 1. Introduction ──────────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["introduction"],
      qa: [
        {
    ...
    // ── 2. Why Agent2Agent? ──────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["why-a2a"],
      qa: [
        {
    ...
    // ── 3. Architecture ──────────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["a2a-architecture"],
      qa: [
        {
    ...
    // ── 4. Setup & Resources ─────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["setup-resources"],
    ...
    // ── 5. First A2A Agent ───────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["first-a2a-agent"],
      qa: [
        {
    ...
    // ── 6. A2A Server ────────────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["a2a-server"],
      qa: [
        {
          question:
    ...
    // ── 7. A2A Client ────────────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["a2a-client"],
      qa: [
        {
          question:
    ...
    // ── 8. Microsoft Agent Framework ─────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["microsoft-agent-framework"],
      qa: [
        {
          question:
    ...
    // ── 9. Google ADK ────────────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["google-adk"],
      qa: [
        {
    ...
    // ── 10. LangGraph ──────────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["langgraph"],
      qa: [
        {
          question:
    ...
    // ── 11. CrewAI ───────────────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["crewai"],
      qa: [
        {
          question:
    ...
    // ── 12. OpenAI Agents SDK ────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["openai-agents-sdk"],
      qa: [
        {
          question:
    ...
    // ── 13. Claude Style Agents ───────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["claude-agent-sdk"],
      qa: [
        {
          question:
    ...
    // ── 14. Multi-Agent Deep Dive (Capstone) ─────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["multi-agent-deep-dive"],
      qa: [
        {
    ...
    // ── 15. Advanced Concepts ────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["advanced-concepts"],
      qa: [
        {
    ...
    // ── 16. Conclusion ───────────────────────────────────────────────────
    {
      ...
      transcript: A2A_TRANSCRIPTS["conclusion"],
      qa: [
        {
          question:
